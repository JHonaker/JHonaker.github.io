...
To find the proportion of each molecule after a given number of intervals, just multiply $$M$$ by $$T$$ that many times. It's that simple. So, to find $$M_{5001}$$ just find $$M_{5001} = M_1 T^{5000}$$.
